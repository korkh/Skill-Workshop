...
export default function TestErrors() {
  ...
  function handleBadGuid() {
    axios.get("/trainings/notaguid").catch((err) => console.log(err.response));
  }

  function handleValidationError() {
    axios.post("/trainings", {}).catch((err) => setErrors(err)); //due to we getting data in agent.ts (not response) we flat() into single array now
  }
